...
const { update_case_status } = require("../../../permissions.json")["cda"];
...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const hasRole = update_case_status.some((roleId) =>
    ...
    try {
      ...
      const successEmbed = new EmbedBuilder()
        ...
        .setDescription(
          "MP discipline case status has been updated successfully."
        )
        .setColor("#00FF00")
        .addFields(
          {
