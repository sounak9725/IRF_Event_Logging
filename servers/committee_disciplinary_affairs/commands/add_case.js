    ...
    run: async (client, interaction) => {
        ...
        try {
            ...
            const successEmbed = new EmbedBuilder()
                ...
                .setDescription('New MP discipline case has been added to the database.')
                .setColor('#00FF00')
                .addFields(
                    {
                        name: 'Offender',
                ...
                .setFooter({ text: `Added by ${interaction.user.username} | Committee Disciplinary Affairs` })
                .setTimestamp();
            ...
            return interactionEmbed(3, "[ERR-ADD-CASE]", 'An error occurred while adding the case.', interaction, client, [true, 30]);
        }
    }
};
